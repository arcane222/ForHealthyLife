...
public class SideDishFragment extends Fragment {
    ...
    public void setKcalSideDish(int kcal, int check){
        final int Kcal = kcal;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_side_dish, container, false);
        ListView listview = view.findViewById(R.id.sidedishName);
    ...
    public class CustomList extends ArrayAdapter<String>
    {
        ...
        {
            super(context, R.layout.food_item, Data.sideDishName);
        ...
        public View getView(int position, View view, ViewGroup parent)
        {
            ...
            imageView.setImageResource(Data.sideDishImage[position]);
            foodName.setText(Data.sideDishName[position]);
            ...
            incrButton.setOnClickListener(new View.OnClickListener()
            {
                ...
                {
                    final int kcal = Data.sideDishKcal[pos];
                    setKcalSideDish(kcal,0);
                    Snackbar.make(v, Data.sideDishName[pos]+" 이 추가되었습니다.",
                            Snackbar.LENGTH_LONG).setAction("되돌리기", new View.OnClickListener()
                    {
                        @Override
                        public void onClick(View view)
                        {
                            setKcalSideDish(kcal,1);
                        }
                    }).show();
